    ...
    <div className='flex w-3/4 items-center justify-start gap-2'>
      {profile.ens.records?.url && (
        <a
          ...
          target='_blank'
          rel='noreferrer'
          className='bg-tertiary mb-1 flex max-w-1/2 items-center gap-1 rounded-sm px-2 py-0.5 text-sm text-blue-600 transition-all hover:scale-110'
        >
          ...
          <Image src={Link} alt='Link' width={16} height={16} className='h-auto w-4' />
        </a>
      )}
