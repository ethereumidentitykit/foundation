...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    base-uri 'none';
    form-action 'self';
    frame-src 'self' https://verify.walletconnect.com/ https://verify.walletconnect.org/ https://vercel.live/ https://secure.walletconnect.org/;
    frame-ancestors * https://verify.walletconnect.org/ https://verify.walletconnect.com/ https://secure.walletconnect.org/;
